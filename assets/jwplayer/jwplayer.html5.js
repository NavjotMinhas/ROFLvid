...
(function(a){
    a.srt=function(h,b){
        var e,d,m=jwplayer.utils,l=m.seconds;
        function j(n){
            if(n==0){
...
function ad(bH){
    switch(bH.newstate){
        case g.BUFFERING:case g.PLAYING:
...
function A(){
    ...
    if(!a.exists(V)){
        ...
        try{
        switch(o.state){
            case b.PLAYING:case b.BUFFERING:
                s.pause();
                break;
            default:
                if(D){
...
(function(g){
    ...
    g.display=function(u,M){
        ...
        function U(){
            ...
            function Z(ac){
            switch(t.jwGetState()){
                case q.PLAYING:case q.BUFFERING:
                    t.jwPause();
                    break;
                default:
                    t.jwPlay();
...
(function(b){
    ...
    b.model=function(j){
        var p=this,l,r,s=a.getCookies(),g={
            controlbar:{},
            display:{}
    },n={
        autostart:f,
    ...
    function k(t){
        var A=(m[t.type]?m[t.type].split(","):[]),x,z;
        if(A.length>0){
            for(x=0;x<A.length;x++){
                var v=A[x],w=v.split("->"),y=w[0],u=w[1]?w[1]:y;
                if(p[u]!=t[y]){
                    p[u]=t[y];
                    z=true
                    }
...
(function(l){
    ...
    l.view=function(M,H){
        var L=M,J=H,am,Y,W,at,D=0,aF=2000,F,aO,R,aE,aP,aA,ap,aw=x.extend({},J.componentConfig("logo")),an,aJ,T,ag=(J.mobilecontrols),aG=s,ah,P,au,aB,aC=s,ax=new a.eventdispatcher();
        x.extend(this,ax);
        function aL(){
            am=aI("div",o);
            am.id=L.id;
...
function ak(){
    ...
    function C(){
    var aU=J.width,aS=J.height,aV=J.componentConfig("controlbar"),aT=J.componentConfig("display");
    G(aS);
...
function ai(aU,aS){
    ...
    var aW=J.playlistsize,aX=J.playlistposition;
...
this.getSafeRegion=function(){
    var aZ=J.controls,a0=x.bounds(Y),aU=a0.top,aX=x.bounds(aE?aE.element():null),aT=(aA.numButtons()>0),aW=x.bounds(aA.element()),aV=x.bounds(ap.element()),aY=(ap.position().indexOf("top")==0),aS={};
